...
const DEV_API_URL = 'https://api-patitasconectadas-docker.onrender.com';
const PROD_API_URL = 'https://api-patitasconectadas-docker.onrender.com'; // Usa la misma ruta base en producción
